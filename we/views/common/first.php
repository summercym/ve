		...
		<div class="container">
			<div class="header" style="margin:15px auto;">
				<ul class="nav nav-pills pull-right" role="tablist">
					...
					<li role="presentation"><a href="http://www.we.cc/">we官网</a></li>
					<li role="presentation"><a href="http://bbs.we.cc/">访问论坛</a></li>
				</ul>
			...
			<div class="panel-body" style="overflow-y:scroll;max-height:400px;line-height:20px;">
				<h3>版权所有 (c)2014，we团队保留所有权利。 </h3>
				<p>
					感谢您选择we - 微信公众平台自助开源引擎（以下简称we，we基于 PHP + MySQL的技术开发，全部源码开放。 <br>
					为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：
				</p>
				<p>
					<strong>一、本授权协议适用且仅适用于we系统(we, MicroEngine. 以下简称we)任何版本，we官方对本授权协议的最终解释权。</strong>
				</p>
				<p>
					<strong>二、协议许可的权利 </strong>
					</p><ol>
						<li>您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用。</li>
						<li>您可以在协议规定的约束和限制范围内修改we源代码或界面风格以适应您的网站要求。</li>
				...
				<p>
					<strong>三、协议规定的约束和限制 </strong>
						...
						<li>未经官方许可，禁止在we的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</li>
				...
				<p>
					<strong>四、有限担保和免责声明 </strong>
						...
						<li>电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始确认本协议并安装  we，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</li>
						<li>如果本软件带有其它软件的整合API示范例子包，这些文件版权不属于本软件官方，并且这些文件是没经过授权发布的，请参考相关软件的使用许可合法的使用。</li>
					</ol>
				<p></p>
			</div>
		</div>
		<form class="form-inline" role="form" action="index.php?r=common/one" method="post">
			<ul class="pager">
			...
			<div class="footer" style="margin:15px auto;">
				<div class="text-center">
					<a href="http://www.we.cc/">关于we</a> &nbsp; &nbsp; <a href="http://bbs.we.cc/">we帮助</a> &nbsp; &nbsp; <a href="http://www.we.cc/">购买授权</a>
				</div>
				<div class="text-center">
					Powered by <a href="http://www.we.cc/"><b>we</b></a> v0.7 © 2014 <a href="http://www.we.cc/">www.we.cc</a>
				</div>
			</div>
		</div>
