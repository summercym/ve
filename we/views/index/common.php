            ...
            <ul>
                ...
                <li class="has-sub">
                    ...
                    <ul class="sub">
                        ...
                        <li><a class="" href="dynamic_tables.html"><span class="sub-menu-text">二维码管理</span></a></li>
                        <li><a class="" href="jqgrid_plugin.html"><span class="sub-menu-text">多客服接入</span></a></li>
                    </ul>
                </li>
                <li class="has-sub">
                    <a href="javascript:;" class="">
