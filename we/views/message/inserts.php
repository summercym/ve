    ...
    <div class="col-md-12">
        ...
        <div class="box border red" id="formWizard">
            ...
            <div class="box-body form">
                <form id="wizForm"  class="form-horizontal" action="index.php?r=message/update" method="post" >
                        ...
                        <div class="wizard-content">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="account">
                                    <input type="hidden" value="<?php echo $arr['message_id']?>" name="id"/>
                                    <div class="form-group">
                                        <label class="control-label col-md-3">规则名称<span class="required">*</span></label>
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" name="message_title" placeholder="Please tell us your name for the public." value="<?php echo $arr['message_title']?>"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" name="message_this" placeholder="Please tell us your test number appid" value="<?php echo $arr['message_this']?>"/>
                                            <span class="error-span"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <textarea  class="span7 basic-content-new"   cols="70" style="height:200px;" name="message_content" ><?php echo $arr['message_content']?></textarea>
